...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_MOUSEMOVE:
	{
		...
		end::Input::UpdateMousePos(true, x, y);
	}break;
	case WM_LBUTTONDOWN:
	{
		end::Input::ProccessMouseInput((int)end::Input::KEY_LEFT_MOUSE_BUTTON, true);
	} break;
	case WM_LBUTTONUP:
	{
		end::Input::ProccessMouseInput((int)end::Input::KEY_LEFT_MOUSE_BUTTON, false);
	} break;
	case WM_RBUTTONDOWN:
	{
		end::Input::ProccessMouseInput((int)end::Input::KEY_RIGHT_MOUSE_BUTTON, true);
	} break;
	case WM_RBUTTONUP:
	{
		end::Input::ProccessMouseInput((int)end::Input::KEY_RIGHT_MOUSE_BUTTON, false);
	} break;
	case WM_KEYDOWN:
	{
		end::Input::ProccessKeyboardInput(wParam, true);
	} break;
	case WM_KEYUP:
	{
		end::Input::ProccessKeyboardInput(wParam, false);
	}break;
	default:
